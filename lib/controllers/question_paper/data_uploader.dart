...
class DataUploader extends GetxController {
  ...
  Future<void> uploadData() async {
    ...
    for(var papers in questionPapers){
      ...
      for (var reviews in papers.reviews!) {
        final allRatings = FirebaseFirestore.instance.collection('allRatings')
            .doc(papers.id!);
        batch.set(allRatings, {
          "allFives": reviews.allFives,
          "allFours": reviews.allFours,
          "allThrees": reviews.allThrees,
          "allTwos": reviews.allTwos,
          "allOnes": reviews.allOnes,
          "rating": reviews.rating,
          "ratingSum": reviews.ratingSum,
